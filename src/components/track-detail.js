...
const TrackDetail = ({ track }) => {
  const { title, description, thumbnail, author, durationInSecond, modulesCount, modules, numberOfViews } = track;
      ...
      <TrackDetails>
        ...
        <DetailRow>
          <DetailItem>
            ...
            <IconAndLabel>
              <IconTime width="14px" />
              <div>{humanReadableTimeFromSeconds(durationInSecond)}</div>
            </IconAndLabel>
          </DetailItem>
          <DetailItem>
            <h4>Author</h4>
